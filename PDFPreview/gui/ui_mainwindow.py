...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuIndent = QMenu(self.menuView)
        self.menuIndent.setObjectName(u"menuIndent")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuIndent.setTitle(QCoreApplication.translate("MainWindow", u"Indent", None))
    # retranslateUi
